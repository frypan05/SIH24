    ...
    <div className="bg-[#081D22] text-white min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-5xl font-bold text-[#8AD4D0] mb-4">PostgreSQL Roadmap</h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            This page provides a roadmap for PostgreSQL development, including key technologies, tools, and skills.
          </p>
        </div>
...
export default postgresqlRoadmap;
